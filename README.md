...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/glimix-core-feedstock/blob/main/LICENSE.txt)

Summary: Fast inference for Generalized Linear Mixed Models

Development: https://github.com/limix/glimix-core

Documentation: https://glimix-core.readthedocs.io/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=371&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/glimix-core-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `glimix-core` can be installed with `conda`:
...
```
mamba install glimix-core
```

It is possible to list all of the versions of `glimix-core` available on your platform with `conda`:
...
```
mamba search glimix-core --channel conda-forge
```
...
mamba repoquery search glimix-core --channel conda-forge

# List packages depending on `glimix-core`:
mamba repoquery whoneeds glimix-core --channel conda-forge

# List dependencies of `glimix-core`:
mamba repoquery depends glimix-core --channel conda-forge
```
